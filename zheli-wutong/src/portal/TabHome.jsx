...
export default function TabHome() {
  return (
    <div className="tab-content active">
      <div className="hero">
        <p style={{ fontSize: '24px', marginBottom: '10px', opacity: 0.9 }}>
          有了病，不担心；少生病，更健康
        </p>
        <h1 style={{ fontSize: '42px', marginBottom: '20px' }}>
          Medtalent agent 智能体矩阵
        </h1>
        <div
          style={{
            width: '80px',
            height: '4px',
            background: 'linear-gradient(90deg, #ffffff, #36CFC9)',
            margin: '0 auto',
            borderRadius: '2px',
          }}
        ></div>
      ...
      <div className="section" style={{ textAlign: 'center', padding: '60px 40px' }}>
        ...
        <h2 className="section-title" style={{ justifyContent: 'center', marginBottom: '30px' }}>
          我们的使命与价值
        </h2>
        <ul
          style={{
